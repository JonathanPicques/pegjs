...
describe('test message', () => {
    it('should read a single message', () => {
        ...
        expect(parser.parse(`Jonathan : Bonjour Vincent, tu as {{ 32 + 1 }} pièces.`)[0]).to.be.deep.equal({
            character: 'Jonathan',
            content: 'Bonjour Vincent, tu as 33 pièces.',
        });
        expect(parser.parse(`{}{{2+2}} : {} {} {{2}} {}}}`)[0]).to.be.deep.equal({character: '{}4', content: '{} {} 2 {}}}'});
    });
});
